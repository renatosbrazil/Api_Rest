...
import br.com.navita.service.ClienteService;
@RestController
@RequestMapping("api")
public class ClienteController {
	...
	public ResponseEntity<Cliente> getObject(@PathVariable("id") Long id) {
	...
	public ResponseEntity<Cliente> create(@Valid @RequestBody Cliente cliente) throws Exception{	
		try {
		clienteService.save(cliente);		
		return new ResponseEntity<Cliente>(HttpStatus.CREATED);
	}catch (Exception e) {
		throw new ValidationException("o E-mail já existe");
	}
	}
	...
	public ResponseEntity<List<Cliente>> delete(@PathVariable Long id) {
		Optional<Cliente> cliente = clienteService.getId(id);
		if(!cliente.isPresent()){
